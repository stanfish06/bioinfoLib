...
def random_feats(X: np.ndarray, gamma: int | float = 1, frequency_seed: int = None):
...
def sketch(
    ...
    # not sure what is going on but this part fails very often
    ...
    #     )
    kh_indices = [process_set(i, inds) for i, inds in enumerate(tqdm(sample_set_inds))]
